    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="bg-surface border-b border-border">
        <div className="max-w-7xl mx-auto px-6 py-6">
          ...
          <p className="text-text-secondary mt-1">Manage your booth reservations</p>
        </div>
      </div>
        ...
        {bookings.length === 0 ? (
          <Card className="p-12 text-center">
            ...
            <Link href="/exhibitions">
              <Button className="bg-accent hover:bg-accent-hover">Browse Exhibitions</Button>
            </Link>
          </Card>
        ) : (
                ...
                <div className="flex items-start justify-between gap-6">
                  <div className="flex-1">
                    ...
                    <div className="grid md:grid-cols-2 gap-4 text-sm text-text-secondary mb-4">
                      ...
                      <p>
                        <span className="font-medium text-foreground">Booth Type:</span>{' '}
