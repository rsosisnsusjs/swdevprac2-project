        ...
        <div className="grid md:grid-cols-2 gap-6 mb-12">
          <Card className="p-6">
            <div className="flex items-start justify-between">
              <div>
                <p className="text-text-secondary text-sm mb-2">Total Exhibitions</p>
                <p className="text-3xl font-bold text-foreground">{stats.exhibitions}</p>
              </div>
        ...
        <div className="grid md:grid-cols-2 gap-6">
          <Link href="/admin/exhibitions">
            <Card className="p-8 hover:shadow-lg transition-shadow cursor-pointer h-full">
              ...
              <h2 className="text-xl font-bold text-foreground mb-2">Manage Exhibitions</h2>
              <p className="text-text-secondary">Create, edit, and delete exhibitions</p>
            </Card>
          </Link>
          ...
          <Link href="/admin/bookings">
            <Card className="p-8 hover:shadow-lg transition-shadow cursor-pointer h-full">
              ...
              <h2 className="text-xl font-bold text-foreground mb-2">View All Bookings</h2>
              <p className="text-text-secondary">Review and manage all booth bookings</p>
            </Card>
          </Link>
        </div>
      </div>
